...
var campaignID = "6a39a340d41d9eecdf1051ff";
...
var initialSrc = "https://ad.marketelitedeals.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("ad.marketelitedeals.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://ad.marketelitedeals.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://ad.marketelitedeals.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
